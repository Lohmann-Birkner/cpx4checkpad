 ...
 */
@Stateless
public class TWmProcessHospitalFinalisationDao extends AbstractCpxDao<TWmProcessHospitalFinalisation> {

    public TWmProcessHospitalFinalisationDao() {
        super(TWmProcessHospitalFinalisation.class);
    }
