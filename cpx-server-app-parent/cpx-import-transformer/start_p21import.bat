...
cd ..
java -cp %CPX_HOME%\sap_import\sqljdbc41.jar;%CPX_HOME%\sap_import\cpx-sap-importer-1.0-SNAPSHOT.jar process.impl.ImportProcess E:\p21-import\inek-big dbsys1:DIRK22 version 2> "%logFile%"	
REM PAUSE