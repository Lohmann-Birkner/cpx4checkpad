...
public class SampleJob extends CpxFileBasedImportJob {
...
//        
//    }
//    public SampleJob(final String pInputDirectory) {
//        setInputDirectory(pInputDirectory);
//    }
    public SampleJob(String pName, String pTargetDatabase, ImportMode pImportMode, String pInputDirectory, boolean pRebuildIndexes, GDRGModel pGrouperModel, 
            CpxJobConstraints pConstraints, long pTimePeriodValue, ChronoUnit pTimePeriodUnit, Date pBeginDate, Date pEndDate, boolean pActive, String pWhatGroup) {
    ...
    public SampleJob(String pInputDirectory, ImportMode pImportMode, boolean pRebuildIndexes, CpxJobConstraints pConstraints) {
