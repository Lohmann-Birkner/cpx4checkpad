 ...
 * @author gerschmann
 */
public class CpxCRGRule extends CRGRule {

    private static final long serialVersionUID = 1L;

    private final transient CpxRuleManagerIF m_manager;
    private Map<String, String> mappingId2TableName = null;

    public CpxCRGRule(CpxRuleManagerIF mgr, Element ele, String identifier, List<CrgRuleTypes> ruleTypes, int analysisGrade) {
        this(mgr, ele, identifier, ruleTypes, analysisGrade, null);
    }

    public CpxCRGRule(CpxRuleManagerIF mgr, Element ele, String identifier, List<CrgRuleTypes> ruleTypes, int analysisGrade, Map<String, String> pMappingId2TableName) {
        super();
        m_manager = mgr;
