...
//    "value"
//})
@XmlRootElement(name = "rules_value")
public class RulesValue implements Serializable {
...
//    }
    ...
    public void setNot(String value) {
        this.not = value != null ? value : String.valueOf(Boolean.FALSE);
    }
    ...
    public void setWert(String value) {
        this.wert = value;//!=null?value:"'"+value+"'";
    }
...
//        try {
//            return "\nRulesValue("+SerializeHelper.getBytes(this)+"){" + 
...
//                    ", kriterium=" + SerializeHelper.getBytes(kriterium) + 
//                    ", method=" + SerializeHelper.getBytes(method) +
//                    ", not=" + SerializeHelper.getBytes2(not).length + 
//                    ", operator=" + SerializeHelper.getBytes(operator) + 
//                    ", parameter=" + SerializeHelper.getBytes(parameter) + 
//                    ", wert=" + SerializeHelper.getBytes(wert) + 
//                    ", opType=" + SerializeHelper.getBytes(opType) + '}'+"\n";
//        } catch (IOException ex) {
//            Logger.getLogger(RulesValue.class.getName()).log(Level.SEVERE, null, ex);
//            return "";
//        }
//    }
    @Override
