 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="007">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Sachverstaendigenbeauftragung")
public class Sachverstaendigenbeauftragung {
    ...
    protected List<Sachverstaendigenbeauftragung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link Sachverstaendigenbeauftragung.PartnerdatenBlock }
     * 
     * 
     */
    public List<Sachverstaendigenbeauftragung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Sachverstaendigenbeauftragung.PartnerdatenBlock>();
        }
