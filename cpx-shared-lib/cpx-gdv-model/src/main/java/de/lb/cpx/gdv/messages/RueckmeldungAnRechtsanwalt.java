 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="027">
 *         &lt;simpleType>
...
@XmlRootElement(name = "RueckmeldungAnRechtsanwalt")
public class RueckmeldungAnRechtsanwalt {
    ...
    protected List<RueckmeldungAnRechtsanwalt.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link RueckmeldungAnRechtsanwalt.PartnerdatenBlock }
     * 
     * 
     */
    public List<RueckmeldungAnRechtsanwalt.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<RueckmeldungAnRechtsanwalt.PartnerdatenBlock>();
        }
