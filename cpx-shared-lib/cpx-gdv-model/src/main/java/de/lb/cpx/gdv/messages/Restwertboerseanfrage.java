 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="008">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Restwertboerseanfrage")
public class Restwertboerseanfrage {
    ...
    protected List<Restwertboerseanfrage.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link Restwertboerseanfrage.PartnerdatenBlock }
     * 
     * 
     */
    public List<Restwertboerseanfrage.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Restwertboerseanfrage.PartnerdatenBlock>();
        }
