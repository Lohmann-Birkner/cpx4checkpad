 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="006">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Sachverstaendigenbericht")
public class Sachverstaendigenbericht {
    ...
    protected List<Sachverstaendigenbericht.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link Sachverstaendigenbericht.PartnerdatenBlock }
     * 
     * 
     */
    public List<Sachverstaendigenbericht.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Sachverstaendigenbericht.PartnerdatenBlock>();
        }
