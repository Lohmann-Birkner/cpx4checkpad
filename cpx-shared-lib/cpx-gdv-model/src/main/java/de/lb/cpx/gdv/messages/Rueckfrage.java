 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="013">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Rueckfrage")
public class Rueckfrage {
    ...
    protected List<Rueckfrage.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link Rueckfrage.PartnerdatenBlock }
     * 
     * 
     */
    public List<Rueckfrage.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Rueckfrage.PartnerdatenBlock>();
        }
