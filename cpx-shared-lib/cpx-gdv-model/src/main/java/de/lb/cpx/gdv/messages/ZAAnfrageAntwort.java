 ...
 *         &lt;element ref="{http://www.gdv-online.de/snetz/namespaces/KSN/release2013}Versichererermittlung" maxOccurs="3"/>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="022">
 *         &lt;simpleType>
...
@XmlRootElement(name = "ZA-AnfrageAntwort")
public class ZAAnfrageAntwort {
    ...
    protected List<Versichererermittlung> versichererermittlung;
    @XmlElement(name = "PartnerdatenBlock", required = true)
    protected ZAAnfrageAntwort.PartnerdatenBlock partnerdatenBlock;
    ...
    /**
     * Gets the value of the versichererermittlung property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the versichererermittlung property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVersichererermittlung().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Versichererermittlung> getVersichererermittlung() {
        if (versichererermittlung == null) {
            versichererermittlung = new ArrayList<Versichererermittlung>();
        }
        return this.versichererermittlung;
    }
     ...
     * @return
     *     possible object is
     *     {@link ZAAnfrageAntwort.PartnerdatenBlock }
     *     
     */
    public ZAAnfrageAntwort.PartnerdatenBlock getPartnerdatenBlock() {
     ...
     *     
     */
    public void setPartnerdatenBlock(ZAAnfrageAntwort.PartnerdatenBlock value) {
