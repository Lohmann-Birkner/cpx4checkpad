 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="037">
 *         &lt;simpleType>
...
@XmlRootElement(name = "AuftragWerkstattvermittlung")
public class AuftragWerkstattvermittlung {
    ...
    protected List<AuftragWerkstattvermittlung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link AuftragWerkstattvermittlung.PartnerdatenBlock }
     * 
     * 
     */
    public List<AuftragWerkstattvermittlung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<AuftragWerkstattvermittlung.PartnerdatenBlock>();
        }
