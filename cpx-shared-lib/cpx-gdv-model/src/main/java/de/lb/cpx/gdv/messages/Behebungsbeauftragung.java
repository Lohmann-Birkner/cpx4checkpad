 ...
 *         &lt;element ref="{http://www.gdv-online.de/snetz/namespaces/KSN/release2013}Behebungsauftrag" maxOccurs="unbounded"/>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element ref="{http://www.gdv-online.de/snetz/namespaces/KSN/release2013}ErgebnisdatenSach" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.gdv-online.de/snetz/namespaces/KSN/release2013}Anhang" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="028">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Behebungsbeauftragung")
public class Behebungsbeauftragung {
    ...
    protected List<Behebungsauftrag> behebungsauftrag;
    ...
    protected List<Behebungsbeauftragung.PartnerdatenBlock> partnerdatenBlock;
    @XmlElement(name = "ErgebnisdatenSach")
    protected List<ErgebnisdatenSach> ergebnisdatenSach;
    ...
    /**
     * Gets the value of the behebungsauftrag property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the behebungsauftrag property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBehebungsauftrag().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Behebungsauftrag> getBehebungsauftrag() {
        if (behebungsauftrag == null) {
            behebungsauftrag = new ArrayList<Behebungsauftrag>();
        }
        return this.behebungsauftrag;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Behebungsbeauftragung.PartnerdatenBlock }
     * 
     * 
     */
    public List<Behebungsbeauftragung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Behebungsbeauftragung.PartnerdatenBlock>();
        }
        return this.partnerdatenBlock;
    }

    /**
     * Gets the value of the ergebnisdatenSach property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ergebnisdatenSach property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getErgebnisdatenSach().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ErgebnisdatenSach> getErgebnisdatenSach() {
        if (ergebnisdatenSach == null) {
            ergebnisdatenSach = new ArrayList<ErgebnisdatenSach>();
        }
        return this.ergebnisdatenSach;
    }
