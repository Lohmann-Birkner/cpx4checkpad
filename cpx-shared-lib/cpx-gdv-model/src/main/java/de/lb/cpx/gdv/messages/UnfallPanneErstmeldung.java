 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="041">
 *         &lt;simpleType>
...
@XmlRootElement(name = "UnfallPanneErstmeldung")
public class UnfallPanneErstmeldung {
    ...
    protected List<UnfallPanneErstmeldung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link UnfallPanneErstmeldung.PartnerdatenBlock }
     * 
     * 
     */
    public List<UnfallPanneErstmeldung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<UnfallPanneErstmeldung.PartnerdatenBlock>();
        }
