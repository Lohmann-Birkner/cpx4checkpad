 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="004">
 *         &lt;simpleType>
...
public class Quittung {
    ...
    protected List<Quittung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link Quittung.PartnerdatenBlock }
     * 
     * 
     */
    public List<Quittung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Quittung.PartnerdatenBlock>();
        }
