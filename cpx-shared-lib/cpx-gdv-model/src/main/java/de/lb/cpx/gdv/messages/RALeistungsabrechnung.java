 ...
 *         &lt;element ref="{http://www.gdv-online.de/snetz/namespaces/KSN/release2013}RALeistungsabrechnungEinzelposition" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="038">
 *         &lt;simpleType>
...
@XmlRootElement(name = "RALeistungsabrechnung")
public class RALeistungsabrechnung {
    ...
    @XmlElement(name = "RALeistungsabrechnungEinzelposition")
    protected List<RALeistungsabrechnungEinzelposition> raLeistungsabrechnungEinzelposition;
    @XmlElement(name = "PartnerdatenBlock", required = true)
    protected List<RALeistungsabrechnung.PartnerdatenBlock> partnerdatenBlock;
    ...
    /**
     * Gets the value of the raLeistungsabrechnungEinzelposition property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the raLeistungsabrechnungEinzelposition property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRALeistungsabrechnungEinzelposition().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RALeistungsabrechnungEinzelposition> getRALeistungsabrechnungEinzelposition() {
        if (raLeistungsabrechnungEinzelposition == null) {
            raLeistungsabrechnungEinzelposition = new ArrayList<RALeistungsabrechnungEinzelposition>();
        }
        return this.raLeistungsabrechnungEinzelposition;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RALeistungsabrechnung.PartnerdatenBlock }
     * 
     * 
     */
    public List<RALeistungsabrechnung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<RALeistungsabrechnung.PartnerdatenBlock>();
        }
