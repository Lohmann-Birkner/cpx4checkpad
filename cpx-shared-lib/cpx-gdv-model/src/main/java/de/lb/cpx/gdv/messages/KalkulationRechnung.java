 ...
 *         &lt;element ref="{http://www.gdv-online.de/snetz/namespaces/KSN/release2013}Kalkulation" maxOccurs="unbounded"/>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="005">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Kalkulation-Rechnung")
public class KalkulationRechnung {
    ...
    protected List<KalkulationRechnung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link KalkulationRechnung.PartnerdatenBlock }
     * 
     * 
     */
    public List<KalkulationRechnung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<KalkulationRechnung.PartnerdatenBlock>();
        }
