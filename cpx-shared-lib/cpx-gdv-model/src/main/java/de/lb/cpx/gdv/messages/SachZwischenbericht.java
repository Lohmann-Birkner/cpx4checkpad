 ...
 *         &lt;element ref="{http://www.gdv-online.de/snetz/namespaces/KSN/release2013}SVErgebnisSach" minOccurs="0"/>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="029">
 *         &lt;simpleType>
...
@XmlRootElement(name = "SachZwischenbericht")
public class SachZwischenbericht {
    ...
    @XmlElement(name = "SVErgebnisSach")
    protected SVErgebnisSach svErgebnisSach;
    @XmlElement(name = "PartnerdatenBlock", required = true)
    protected List<SachZwischenbericht.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link SachZwischenbericht.PartnerdatenBlock }
     * 
     * 
     */
    public List<SachZwischenbericht.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<SachZwischenbericht.PartnerdatenBlock>();
        }
