 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="018">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Leistungsabrechnung")
public class Leistungsabrechnung {
    ...
    protected List<Leistungsabrechnung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link Leistungsabrechnung.PartnerdatenBlock }
     * 
     * 
     */
    public List<Leistungsabrechnung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Leistungsabrechnung.PartnerdatenBlock>();
        }
