 ...
 *         &lt;element ref="{http://www.gdv-online.de/snetz/namespaces/KSN/release2013}SatzartZurFreienVerfuegung" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="019">
 *         &lt;simpleType>
...
@XmlRootElement(name = "individuelleLE")
public class IndividuelleLE {
    ...
    @XmlElement(name = "SatzartZurFreienVerfuegung")
    protected List<SatzartZurFreienVerfuegung> satzartZurFreienVerfuegung;
    @XmlElement(name = "PartnerdatenBlock", required = true)
    protected List<IndividuelleLE.PartnerdatenBlock> partnerdatenBlock;
    ...
    /**
     * Gets the value of the satzartZurFreienVerfuegung property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the satzartZurFreienVerfuegung property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSatzartZurFreienVerfuegung().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SatzartZurFreienVerfuegung> getSatzartZurFreienVerfuegung() {
        if (satzartZurFreienVerfuegung == null) {
            satzartZurFreienVerfuegung = new ArrayList<SatzartZurFreienVerfuegung>();
        }
        return this.satzartZurFreienVerfuegung;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IndividuelleLE.PartnerdatenBlock }
     * 
     * 
     */
    public List<IndividuelleLE.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<IndividuelleLE.PartnerdatenBlock>();
        }
