 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="036">
 *         &lt;simpleType>
...
@XmlRootElement(name = "SachSVErgebnis")
public class SachSVErgebnis {
    ...
    protected List<SachSVErgebnis.PartnerdatenBlock> partnerdatenBlock;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SachSVErgebnis.PartnerdatenBlock }
     * 
     * 
     */
    public List<SachSVErgebnis.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<SachSVErgebnis.PartnerdatenBlock>();
        }
