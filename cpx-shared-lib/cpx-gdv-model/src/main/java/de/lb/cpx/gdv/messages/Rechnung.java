 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="015">
 *         &lt;simpleType>
...
public class Rechnung {
    ...
    protected List<Rechnung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Rechnung.PartnerdatenBlock }
     * 
     * 
     */
    public List<Rechnung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Rechnung.PartnerdatenBlock>();
        }
