 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="014">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Fahrzeugbewertung")
public class Fahrzeugbewertung {
    ...
    protected List<Fahrzeugbewertung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link Fahrzeugbewertung.PartnerdatenBlock }
     * 
     * 
     */
    public List<Fahrzeugbewertung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Fahrzeugbewertung.PartnerdatenBlock>();
        }
