 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="043">
 *         &lt;simpleType>
...
@XmlRootElement(name = "PanneAnderesVU")
public class PanneAnderesVU {
    ...
    protected List<PanneAnderesVU.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link PanneAnderesVU.PartnerdatenBlock }
     * 
     * 
     */
    public List<PanneAnderesVU.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<PanneAnderesVU.PartnerdatenBlock>();
        }
