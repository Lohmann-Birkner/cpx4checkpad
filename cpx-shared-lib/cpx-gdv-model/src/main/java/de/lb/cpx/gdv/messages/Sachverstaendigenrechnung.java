 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="017">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Sachverstaendigenrechnung")
public class Sachverstaendigenrechnung {
    ...
    protected List<Sachverstaendigenrechnung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link Sachverstaendigenrechnung.PartnerdatenBlock }
     * 
     * 
     */
    public List<Sachverstaendigenrechnung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<Sachverstaendigenrechnung.PartnerdatenBlock>();
        }
