 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="042">
 *         &lt;simpleType>
...
@XmlRootElement(name = "UnfallPanneFolgemeldung")
public class UnfallPanneFolgemeldung {
    ...
    protected List<UnfallPanneFolgemeldung.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link UnfallPanneFolgemeldung.PartnerdatenBlock }
     * 
     * 
     */
    public List<UnfallPanneFolgemeldung.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<UnfallPanneFolgemeldung.PartnerdatenBlock>();
        }
