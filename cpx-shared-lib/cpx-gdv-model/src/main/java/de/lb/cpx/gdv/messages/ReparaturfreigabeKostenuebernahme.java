 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Nachrichtentyp" fixed="002">
 *         &lt;simpleType>
...
@XmlRootElement(name = "Reparaturfreigabe-Kostenuebernahme")
public class ReparaturfreigabeKostenuebernahme {
    ...
    protected List<ReparaturfreigabeKostenuebernahme.PartnerdatenBlock> partnerdatenBlock;
     ...
     * {@link ReparaturfreigabeKostenuebernahme.PartnerdatenBlock }
     * 
     * 
     */
    public List<ReparaturfreigabeKostenuebernahme.PartnerdatenBlock> getPartnerdatenBlock() {
        if (partnerdatenBlock == null) {
            partnerdatenBlock = new ArrayList<ReparaturfreigabeKostenuebernahme.PartnerdatenBlock>();
        }
