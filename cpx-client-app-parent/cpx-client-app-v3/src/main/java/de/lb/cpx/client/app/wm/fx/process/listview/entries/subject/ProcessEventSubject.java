 ...
 * @author niemeier
 */
public class ProcessEventSubject extends EventSubject<TWmProcess> {

    public ProcessEventSubject(final WmEventTypeEn pType, final TWmProcess pItem) {
        super(pType, pItem);
    }

    public ProcessEventSubject(TWmEvent pEvent) {
        super(pEvent);
    }
