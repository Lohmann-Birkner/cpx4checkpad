...
import de.lb.cpx.client.app.wm.fx.process.listview.entries.subject.ProcessFinalisationEventSubject;
 ...
 * @author wilde
 */
public class ProcessFinalisationHistoryEntry extends HistoryEntry<TWmProcessHospitalFinalisation> {

    public ProcessFinalisationHistoryEntry(ProcessServiceFacade pFacade, TWmEvent pEvent, boolean pReadOnly) {
...
//    }
    ...
    @Override
    public ProcessFinalisationEventSubject getEventSubject() {
        return new ProcessFinalisationEventSubject(event);
    }
