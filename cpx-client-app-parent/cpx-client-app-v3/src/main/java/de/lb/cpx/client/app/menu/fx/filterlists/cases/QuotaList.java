...
/**
 * audit quota specific fitler tableview
 *
 * @author niemeier
 */
public class QuotaList extends FilterTableView<WorkingListItemDTO, WorkingListFXMLController> {

    public QuotaList(WorkingListFXMLController pWorkingList) {
        super(pWorkingList);
...
//        });
        ...
        setFilterColumnFactory(new Callback<SearchListAttribute, FilterColumn<WorkingListItemDTO, ? extends Object>>() {
            ...
            public FilterColumn<WorkingListItemDTO, ? extends Object> call(SearchListAttribute param) {
                QuotaListColumn col = new QuotaListColumn(param);
                return col;
            }
        });
        maxItemsProperty().bind(getFilterListFXMLController().getScene().maxItemProperty());

        setRowContextMenu(new QuotaContextMenu(getFilterListFXMLController()));

//        addMenuItem(getFilterListFXMLController().createAddCaseButton());
        //addMenuItem(getFilterListFXMLController().createQuotaFilterButton());
