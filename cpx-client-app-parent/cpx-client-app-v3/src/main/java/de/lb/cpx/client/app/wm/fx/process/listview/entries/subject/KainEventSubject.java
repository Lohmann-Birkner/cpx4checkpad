 ...
 * @author niemeier
 */
public class KainEventSubject extends EventSubject<TP301Kain> {

    public KainEventSubject(final WmEventTypeEn pType, final TP301Kain pItem) {
        super(pType, pItem);
    }

    public KainEventSubject(TWmEvent pEvent) {
        super(pEvent);
    }
