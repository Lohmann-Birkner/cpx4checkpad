 ...
 * @author wilde
 */
public class SelectedWardItem extends DepTitledPaneSelectedItem{
    
    public SelectedWardItem(TCaseWard pItem, TCaseDepartment pDepartment) {
        super(pItem, pDepartment);
    }
