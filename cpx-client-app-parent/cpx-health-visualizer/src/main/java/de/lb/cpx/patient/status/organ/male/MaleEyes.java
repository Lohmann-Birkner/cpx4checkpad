 ...
 * @author niemeier
 */
public class MaleEyes extends Eyes2 {

    public static final String GRAPHIC_FILE_PATH = "male/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 10.3d;
    public static final double POSITION_X = 0.0d;
    public static final double POSITION_Y = -88.0d;

    public MaleEyes(final BodyGraphic pBody) {
