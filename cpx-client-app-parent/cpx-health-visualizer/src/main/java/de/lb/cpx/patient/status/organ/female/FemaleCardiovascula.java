 ...
 * @author niemeier
 */
public class FemaleCardiovascula extends Cardiovascula9 {

    public static final String GRAPHIC_FILE_PATH = "female/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 98.0d;
    public static final double POSITION_X = 0.0d;
    public static final double POSITION_Y = 0.5d;

    public FemaleCardiovascula(final BodyGraphic pBody) {
