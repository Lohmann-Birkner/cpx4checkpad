 ...
 * @author niemeier
 */
public class FemaleUrinaryOrgans extends UrinaryOrgans5 {

    public static final String GRAPHIC_FILE_PATH = "female/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 19.3d;
    public static final double POSITION_X = -0.1d;
    public static final double POSITION_Y = -4.6d;

    public FemaleUrinaryOrgans(final BodyGraphic pBody) {
