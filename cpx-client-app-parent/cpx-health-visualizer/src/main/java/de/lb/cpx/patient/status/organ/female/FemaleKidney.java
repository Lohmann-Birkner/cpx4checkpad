 ...
 * @author niemeier
 */
public class FemaleKidney extends Kidney12 {

    public static final String GRAPHIC_FILE_PATH = "female/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 20.7d;
    public static final double POSITION_X = 0.0d;
    public static final double POSITION_Y = -14.4d;

    public FemaleKidney(final BodyGraphic pBody) {
