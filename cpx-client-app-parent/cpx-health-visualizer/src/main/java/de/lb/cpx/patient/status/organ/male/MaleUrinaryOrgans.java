 ...
 * @author niemeier
 */
public class MaleUrinaryOrgans extends UrinaryOrgans5 {

    public static final String GRAPHIC_FILE_PATH = "male/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 21.0d;
    public static final double POSITION_X = 0.0d;
    public static final double POSITION_Y = -4.0d;

    public MaleUrinaryOrgans(final BodyGraphic pBody) {
