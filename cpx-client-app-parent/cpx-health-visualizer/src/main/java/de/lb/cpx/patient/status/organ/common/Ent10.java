...
import de.lb.cpx.patient.status.organ.female.FemaleEnt;
import de.lb.cpx.patient.status.organ.male.MaleEnt;
 ...
 * @author niemeier
 */
public abstract class Ent10 extends AbstractOrganGraphic {

    public static final String ID = "ent";
    public static final String NAME_ENGLISH = "ENT";
    public static final String NAME_GERMAN = "HNO";
    public static final String GRAPHIC_FILE_NAME = "ent.svg";
    public static final int NUMBER = 10;

    public Ent10(final BodyGraphic pBody, final String pId,
    ...
    public static Ent10 instance(final Body16 pBody, final char pGender) {
        if (AbstractHumanPartGraphic.isFemale(pGender)) {
            return new FemaleEnt(pBody);
        }
        if (AbstractHumanPartGraphic.isMale(pGender)) {
            return new MaleEnt(pBody);
        }
        return new MaleEnt(pBody);
    }
