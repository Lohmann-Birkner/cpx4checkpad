 ...
 * @author niemeier
 */
public class FemaleTeeth extends Teeth14 {

    public static final String GRAPHIC_FILE_PATH = "female/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 5.5d;
    public static final double POSITION_X = 0.0d;
    public static final double POSITION_Y = -79.0d;

    public FemaleTeeth(final BodyGraphic pBody) {
