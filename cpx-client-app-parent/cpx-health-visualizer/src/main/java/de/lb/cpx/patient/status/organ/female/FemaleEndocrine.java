 ...
 * @author niemeier
 */
public class FemaleEndocrine extends Endocrine3 {

    public static final String GRAPHIC_FILE_PATH = "female/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 59.0d;
    public static final double POSITION_X = 0.0d;
    public static final double POSITION_Y = -40.5d;

    public FemaleEndocrine(final BodyGraphic pBody) {
