 ...
 * @author niemeier
 */
public class FemaleMusculoskeletal extends Musculoskeletal11 {

    public static final String GRAPHIC_FILE_PATH = "female/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 99.0d;
    public static final double POSITION_X = -0.3d;
    public static final double POSITION_Y = 0.0d;

    public FemaleMusculoskeletal(final BodyGraphic pBody) {
