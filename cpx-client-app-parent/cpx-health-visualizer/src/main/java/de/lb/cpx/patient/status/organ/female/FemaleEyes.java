 ...
 * @author niemeier
 */
public class FemaleEyes extends Eyes2 {

    public static final String GRAPHIC_FILE_PATH = "female/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 10.8d;
    public static final double POSITION_X = 0.0d;
    public static final double POSITION_Y = -87.0d;

    public FemaleEyes(final BodyGraphic pBody) {
