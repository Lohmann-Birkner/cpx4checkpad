 ...
 * @author niemeier
 */
public class FemalePsychosocial extends Psychosocial13 {

    public static final String GRAPHIC_FILE_PATH = "female/" + GRAPHIC_FILE_NAME;
    public static final double RELATIVE_SIZE = 11.5d;
    public static final double POSITION_X = 0.0d;
    public static final double POSITION_Y = -93.0d;

    public FemalePsychosocial(final BodyGraphic pBody) {
