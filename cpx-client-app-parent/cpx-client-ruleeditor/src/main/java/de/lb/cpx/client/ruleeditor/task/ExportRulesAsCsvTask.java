 ...
 * @author wilde
 */
public class ExportRulesAsCsvTask extends ExportRulesCsvExcelTask{

    public ExportRulesAsCsvTask(List<ColumnOption> pColumnOptions, List<CrgRules> pRules, CrgRulePools pPool, File pDirectory) {
        super(pColumnOptions, pRules, pPool, pDirectory);
    }

    @Override
    public RuleListExporter getRuleListExporter() {
        return new RuleListCsvExporter();
    }
