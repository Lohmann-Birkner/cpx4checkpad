 ...
 * @param <T> type
 */
public abstract class PeppCarePercInfColumn<T> extends IntegerColumn<T> {

    public PeppCarePercInfColumn() {
        super(Lang.getCarePercInf());
    }
    ...
    public Integer extractValue(T pValue) {
        ...
        if (pepp != null) {
            return pepp.getPeppcDaysPerscareInf();
        }
        return null;
    }
}
