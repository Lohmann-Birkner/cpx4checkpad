 ...
 * @param <T> type
 */
public abstract class PeppCarePercAdultColumn<T> extends IntegerColumn<T> {

    public PeppCarePercAdultColumn() {
        super(Lang.getCarePercAdult());
    }
    ...
    public Integer extractValue(T pValue) {
        ...
        if (pepp != null) {
            return pepp.getPeppcDaysPerscareAdult();
        }
        return null;
    }
}
