 ...
 * {@link Spinner Spinner control} - without a value factory installed a Spinner
 * is unusable. It is the role of the value factory to handle almost all aspects
 * of the Spinner, including:
 *
 * <ul>
 * <li>Representing the current state of the
 * {@link javafx.scene.control.SpinnerValueFactory#valueProperty() value},</li>
 * <li>{@link SpinnerValueFactory#increment(int) Incrementing} and
 * {@link SpinnerValueFactory#decrement(int) decrementing} the value, with one
 * or more steps per call,</li>
 * <li>{@link javafx.scene.control.SpinnerValueFactory#converterProperty() Converting}
 * text input from the user (via the Spinner
 * {@link Spinner#editorProperty() editor},</li>
 * <li>Converting
 * {@link javafx.scene.control.SpinnerValueFactory#converterProperty() objects to user-readable strings}
 * for display on screen</li>
 * </ul>
 *
 * <p>
 * SpinnerValueFactory classes for some common types are provided with JavaFX,
 * including:
 *
 *
 * <ul>
...
public abstract class SpinnerValueFactory<T> {
    ...
    private static final Logger LOG = Logger.getLogger(SpinnerValueFactory.class.getName());
     ...
     * {@link Spinner#editableProperty() editable}) to an object of type T, such
     * that the input may be retrieved via the {@link #valueProperty() value}
     * property.
     */
    ...
    public static class ListSpinnerValueFactory<T> extends SpinnerValueFactory<T> {
        ...
        /**
         * Sets the underlying data model for the ListSpinnerValueFactory. Note
         * that it has a generic type that must match the type of the Spinner
         * itself.
         *
         * @param value List of Observalble items for the ListSpinner
         */
        ...
        /**
         * Returns an {@link javafx.collections.ObservableList} that contains
         * the items currently able to be iterated through by the user. This may
         * be null if {@link #setItems(javafx.collections.ObservableList)} has
         * previously been called, however, by default it is an empty
         * ObservableList.
         *
         * @return An ObservableList containing the items to be shown to the
         * user, or null if the items have previously been set to null.
         */
        ...
        /**
         * The underlying data model for the ListView. Note that it has a
         * generic type that must match the type of the ListView itself.
         *
         * @return List-obejct as Objectproperty
         */
        public final ObjectProperty<ObservableList<T>> itemsProperty() {
            if (items == null) {
                items = new SimpleObjectProperty<ObservableList<T>>(this, "items") {
                    private WeakReference<ObservableList<T>> oldItemsRef;
    ...
    public static class IntegerSpinnerValueFactory extends SpinnerValueFactory<Integer> {
         ...
         */
        /**
         * Constructs a new IntegerSpinnerValueFactory that sets the initial
         * value to be equal to the min value, and a default
         ...
         * must be within the bounds of the min and max arguments, or else the
         ...
         * must be within the bounds of the min and max arguments, or else the
         * min value will be used.
         * @param amountToStepBy The amount to increment or decrement by, per
         * step.
         */
        public IntegerSpinnerValueFactory(@NamedArg("min") int min,
                @NamedArg("max") int max,
            ...
            valueProperty().addListener((o, oldValue, newValue) -> {
                ...
                // valid value (and if not, blow up appropriately)
                if (newValue == null) {
                    int resetValue = getMin() > 0 ? getMin() : 0;
                    setValue(resetValue); //set to 0 or minimum value if 0 is not allowed
                    //setValue(oldValue);
         ...
         *
         * @return minimal IntegerProperty
         */
         ...
         *
         * @return maximal IntegerProperty
         */
    ...
    public static class DoubleSpinnerValueFactory extends SpinnerValueFactory<Double> {
        ...
        /**
         * Constructs a new DoubleSpinnerValueFactory that sets the initial
         * value to be equal to the min value, and a default
         * {@code amountToStepBy} of one.
         *
            ...
            setConverter(new StringConverter<Double>() {
                ...
                public Double fromString(String value) {
                    try {
                        ...
                        LOG.log(Level.SEVERE, "This is not a valid double: " + value);
                        return null;
                    }
                }
            });
         ...
         * Sets the minimum allowable value for this value factory
         *
         * @return return minimal doubleProperty
         */
         ...
         * Sets the amount to increment or decrement by, per step.
         *
         * @return amount of increment Steps
         */
    ...
    public static class LocalDateSpinnerValueFactory extends SpinnerValueFactory<LocalDate> {
         ...
         * value returned by calling {@code LocalDate#now()} as the initial
         * value, and using a stepping amount of one day.
         */
         ...
         *
         * <ul>
         * <li><strong>To step by one day from today: </strong>
         * {@code new LocalDateSpinnerValueFactory(LocalDate.MIN, LocalDate.MAX, LocalDate.now(), 1, ChronoUnit.DAYS)}</li>
         * <li><strong>To step by one month from today: </strong>
         * {@code new LocalDateSpinnerValueFactory(LocalDate.MIN, LocalDate.MAX, LocalDate.now(), 1, ChronoUnit.MONTHS)}</li>
         * <li><strong>To step by one year from today: </strong>
         * {@code new LocalDateSpinnerValueFactory(LocalDate.MIN, LocalDate.MAX, LocalDate.now(), 1, ChronoUnit.YEARS)}</li>
         * </ul>
         *
         * @param min The minimum allowed double value for the Spinner.
         * @param max The maximum allowed double value for the Spinner.
         ...
         * @param amountToStepBy The amount to increment or decrement by, per
         * step.
         * @param temporalUnit The size of each step (e.g. day, week, month,
         * year, etc)
         */
        public LocalDateSpinnerValueFactory(@NamedArg("min") LocalDate min,
                @NamedArg("min") LocalDate max,
    ...
    public static class LocalTimeSpinnerValueFactory extends SpinnerValueFactory<LocalTime> {
         ...
         * value returned by calling {@code LocalTime#now()} as the initial
         * value, and using a stepping amount of one day.
         */
         ...
         *
         * <ul>
         * <li><strong>To step by one hour from the current time: </strong>
         * {@code new LocalTimeSpinnerValueFactory(LocalTime.MIN, LocalTime.MAX, LocalTime.now(), 1, ChronoUnit.HOURS)}</li>
         * <li><strong>To step by one minute from the current time: </strong>
         * {@code new LocalTimeSpinnerValueFactory(LocalTime.MIN, LocalTime.MAX, LocalTime.now(), 1, ChronoUnit.MINUTES)}</li>
         * </ul>
         *
         * @param min The minimum allowed double value for the Spinner.
         * @param max The maximum allowed double value for the Spinner.
         ...
         * Sets the minimum allowable value for this value factory
         *
         * @return minimal LocalTime Value
         */
