 ...
 * @param <T> type
 */
public abstract class PeppSpDfValueColumn<T> extends CurrencyColumn<T> {

    public PeppSpDfValueColumn() {
        super(Lang.getSfDfValue());
        setEmptyText("");
    }
    ...
    public Double extractValue(T pValue) {
        ...
        if (grpOps != null && grpOps.getCaseSupplFees() != null) {
            ...
            if (supFee.getCsuplTypeEn().equals(SupplFeeTypeEn.ET) || supFee.getCsuplTypeEn().equals(SupplFeeTypeEn.ZP)) {
