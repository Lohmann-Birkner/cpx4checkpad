 ...
 */
public class CpxSupplementaryDailyFeeCatalog extends AbstractCpxSupplementaryFeeCatalog {

    private static CpxSupplementaryDailyFeeCatalog instance = null;
    public static final CatalogTypeEn CATALOG = CatalogTypeEn.ET;

    public static synchronized CpxSupplementaryDailyFeeCatalog instance() {
        if (instance == null) {
            instance = new CpxSupplementaryDailyFeeCatalog();
        }
        return instance;
    }
    //Logger log = Logger.getLogger(getClass().getSimpleName());

    private CpxSupplementaryDailyFeeCatalog() {
