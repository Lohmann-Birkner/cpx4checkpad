...
/**
 * Column class to display rule category
 *
 * @author wilde
 */
public class RuleCategoryColumn extends StringColumn<CpxSimpleRuleDTO> {

    /**
     * construct new instance with default header text enable with overrun
     */
    public RuleCategoryColumn() {
        super(Lang.getCaseResolveRulesCategorie(), true);
