 ...
 */
public class LabeledComboBox<T> extends LabeledControl<CpxComboBox<T>> {

    private static final Logger LOG = Logger.getLogger(LabeledComboBox.class.getName());
...
//                getControl().getSelectionModel().select(getControl().getSelectionModel().getSelectedItem()!=null?getControl().getSelectionModel().getSelectedIndex():0);
            ...
            private void selectDown() {
                ...
                //int index = ((ListView) ((CpxComboBoxListViewSkin) getControl().getSkin()).getPopupContent()).getSelectionModel().getSelectedIndex();
                int index = (((CpxComboBoxListViewSkin) getControl().getSkin()).getListView()).getSelectionModel().getSelectedIndex();
     ...
     */
    public LabeledComboBox(String pLabel) {
        super(pLabel, new CpxComboBox<>());
        setListener();
    }
    ...
    public LabeledComboBox(String pLabel, T... items) {
        this(pLabel);
        setItems(items);
        setListener();
    }
    ...
    public final void setItems(T... items) {
        getControl().setItems(FXCollections.observableArrayList(items));
    }
    ...
    /**
     * Calls ComboBox.getItems.isEmpty and returns it
     *
     * @return Size of Items in the ComboBox
     */
    ...
    public void select(T select) {
        getControl().getSelectionModel().select(select);
    }
