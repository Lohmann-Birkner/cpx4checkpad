 ...
 * @author wilde
 */
public class RuleRiskAuditPercentValueColumn extends StringColumn<CpxSimpleRuleDTO>{

    public RuleRiskAuditPercentValueColumn() {
        super(Lang.getRiskEditorRiskAuditValueObj().getAbbreviation());
        setMinWidth(65.0);
        setMaxWidth(65.0);
        setResizable(false);
    }
    ...
    public String extractValue(CpxSimpleRuleDTO pValue) {
        Integer percent = pValue.getRiskAuditPercentValue();
