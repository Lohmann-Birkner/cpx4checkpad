 ...
 */
public class CpxSupplementaryDrgFeeCatalog extends AbstractCpxSupplementaryFeeCatalog {

    private static CpxSupplementaryDrgFeeCatalog instance = null;
    public static final CatalogTypeEn CATALOG = CatalogTypeEn.ZE;

    public static synchronized CpxSupplementaryDrgFeeCatalog instance() {
        if (instance == null) {
            instance = new CpxSupplementaryDrgFeeCatalog();
        }
        return instance;
    }
    //Logger log = Logger.getLogger(getClass().getSimpleName());

    private CpxSupplementaryDrgFeeCatalog() {
