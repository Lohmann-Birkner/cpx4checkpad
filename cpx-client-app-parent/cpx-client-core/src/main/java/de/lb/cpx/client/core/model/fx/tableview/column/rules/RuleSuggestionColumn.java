...
/**
 * Column class to show suggestion(Vorschlag) to a rule
 *
 * @author wilde
 */
public class RuleSuggestionColumn extends StringColumn<CpxSimpleRuleDTO> {

    /**
     * creates new instance with default header enables overrun behavior
     */
    public RuleSuggestionColumn() {
        super(Lang.getCaseResolveRulesProposal(), true);
    }

    @Override
    public String extractValue(CpxSimpleRuleDTO pValue) {
        return pValue.getRuleSuggestion();
    }
